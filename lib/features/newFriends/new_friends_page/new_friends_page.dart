...
import 'package:beaver/features/newFriends/new_friends_page/bloc/bloc.dart';
import 'package:beaver/features/newFriends/new_friends_page/bloc/event.dart';
import 'package:beaver/features/newFriends/new_friends_page/bloc/state.dart';
import 'package:beaver/features/newFriends/new_friends_page/data/repositories/repository.dart';
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '暂无${state.activeTab == 'received' ? '收到' : '发出'}的好友申请',
                          style: TextStyle(
                            fontSize: 16.w,
                            fontWeight: FontWeight.w600,
                            color: const Color(0xFF2D3436),
