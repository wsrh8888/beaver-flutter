...
import 'package:beaver/features/setting/privacy_page/bloc/bloc.dart';
import 'package:beaver/features/setting/privacy_page/bloc/event.dart';
import 'package:beaver/features/setting/privacy_page/bloc/state.dart';
import 'package:beaver/features/setting/privacy_page/data/repositories/repository.dart';
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text: '注意：',
                      style: TextStyle(color: Color(0xFFFF7D45), fontWeight: FontWeight.w600),
                    ),
                    TextSpan(text: additionalContent.replaceFirst('注意：', '')),
                  ],
                ),
              ),
            ),
