...
import 'package:beaver/features/setting/legal/privacy/bloc/bloc.dart';
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSection(
                            title: '4. 数据安全',
                            content: '我们采取合理的技术、管理和物理措施来保护您的信息不被未经授权的访问、使用或披露。但请了解，互联网传输方式无法保�?00%的安全性�?,
                          ),
                          // 信息存储与国际传�?
                          _buildSection(
                            title: '5. 信息存储与国际传�?,
                            content: '我们可能在您所在国�?地区以外的服务器上处理和存储您的信息。使用我们的服务，即表示您同意这种国际传输和处理�?,
                          ),
                          // 您的权利与选择
                          _buildSection(
                            title: '6. 您的权利与选择',
