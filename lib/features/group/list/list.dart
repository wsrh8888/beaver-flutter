        ...
        builder: (context, state) {
          return BeaverLayout(
            ...
            child: ListView.separated(
              ...
              separatorBuilder: (context, index) => Divider(height: 1.w, color: Colors.grey.withValues(alpha: 0.1)),
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () => context.push('/chat/detail?id=${group.conversationId}&type=group'),
                );
              },
            ),
          );
