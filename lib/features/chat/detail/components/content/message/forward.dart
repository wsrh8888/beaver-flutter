...
class ForwardMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleColor = isSelf ? Colors.white : const Color(0xFF2D3436);
    final countColor = isSelf ? Colors.white70 : const Color(0xFF636E72);
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          "${msg.count} 条消息",
          style: TextStyle(fontSize: 12.sp, color: countColor),
        ),
        Divider(color: isSelf ? Colors.white24 : null),
        Text(
          "聊天记录",
